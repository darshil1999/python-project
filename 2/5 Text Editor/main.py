...
savebtn = Button(root, command=save, text="Save")
savebtn.grid(row=1, column=0)
savebtn.config(font=('arial', 20, "bold"))

fontbtn = Menubutton(root, text="Font")
fontbtn.config(font = ('arial', 20, "bold"))
...
boldbtn = Button(root, command=bold, text="Bold")
boldbtn.config(font=('arial', 20, "bold"))
