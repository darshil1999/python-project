...
# draw rectangel, trangle and square with red, yellow, and blue color
def draw(a,l,m):
    global base1
    if a=='A':
...
# defining quiz board for easy level which is 4x4
def quizboard():
    ...
    # check if all the tiles are flipped or not
    if count==16:
        base1.create_text(200,450,text="No. of moves: "+str(moves1),font=('arial',20))
        messagebox.showinfo("Won!", f"You won in {moves1} moves.")
...
random.shuffle(ans1)
ans1 = [ans1[:4], ans1[4:8], ans1[8:12], ans1[12:]] 
...
# board having 4x4 tiles as a list format
...
def puzzleboard2():
    ...
    if count>=36:
        ...
        messagebox.showinfo("Won!", f"You won in {moves2} moves.")
...
random.shuffle(ans2)
ans2 = [ans2[:6], ans2[6:12], ans2[12:18], ans2[18:24], ans2[24:30], ans2[30:]]
...
def quizboard3():
    ...
    if count>=64:
        ...
        messagebox.showinfo("Won!", f"You won in {moves3} moves.")
...
random.shuffle(ans3)
ans3 = [ans3[:8], ans3[8:16], ans3[16:24], ans3[24:32], ans3[32:40], ans3[40:48], ans3[48:56], ans3[56:]]
